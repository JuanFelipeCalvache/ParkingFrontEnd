...
const EntryForm = () => {
    ...
    return(
        <div className="max-w-xl mx-auto  bg-gray-800/80 p-2 rounded-xl shadow-lg border-4 border-fuchsia-600/30 text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 rounded-md border-4">

                <div>
                    <label className="block mb-1 mt-6">Vehicle Plate:</label>
                    <input 
                    type="text"
                    name="plate"
                ...
                <div>
                    <label className="block mb-1">Parking space:</label>
                    <select
                        name="spaceId"
                        value={formData.spaceId}
                        onChange={handleChange}
                        className="p-1 rounded max-w-dvh bg-gray-700 border border-gray-600 text-white"
                        required
                    >
                ...
                <button
                    type="submit"
                    className="bg-fuchsia-600 hover:bg-fuchsia-700 px-4 py-2 tounded text-white"
                >
                    Register Entry
                </button>
            </form>
